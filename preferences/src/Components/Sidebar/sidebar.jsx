      ...
      <div className="row">
        ...
        <div className="col-md-9">
          ...
          <h2>Partner Preferences</h2>
            ...
            <div className="Main">
                <h3>
                <img src="/Basic_Preferences.png" alt="icon" className="document-icon" />
                Basic Preferences</h3>
                
                <div className="preference-item">
                    <span>Groom's Age</span>
                    <img src="/edit_icon.png" alt="Edit" className="edit-icon" />
            ...
            <div className="Main">
            <h3>
            <img src="/Religious_preferences.png" alt="icon" className="document-icon" />
            ...
            <div className="Main">
                <h3><img src="/proffesionaal_preferences.png" alt="icon" className="document-icon" />Professional Preferences
                </h3>
            ...
            <div className="Main">
                <h3><img src="/Location_preferences.png" alt="icon" className="document-icon" />
            ...
            <div className="Main">
                <h3><img src="/What_we_are_looking_for.png" alt="icon" className="document-icon" />
